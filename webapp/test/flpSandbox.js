		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zprojectmaestrorep-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectmaestrorep-display": {
								"semanticObject": "zprojectmaestrorep",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zproject.maestrorep",
									"url": sap.ui.require.toUrl("zproject/maestrorep")
								}
							}
						}
					}
